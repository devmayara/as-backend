...
export const getGroup: RequestHandler = async (req, res): Promise<any> => {
...
export const addGroup: RequestHandler = async (req, res): Promise<any> => {
    const { id_event } = req.params;
...
export const updateGroup: RequestHandler = async (req, res): Promise<any> => {
    const { id, id_event } = req.params;
...
export const deletedGroup: RequestHandler = async (req, res): Promise<any> => {
    const { id, id_event } = req.params;
