...
router.delete("/events/:id", auth.validate, events.deletedEvent);
...
router.delete("/events/:id_event/groups/:id", auth.validate, groups.deletedGroup);
...
router.delete("/events/:id_event/groups/:id_group/people/:id", auth.validate, people.deletedPerson);
